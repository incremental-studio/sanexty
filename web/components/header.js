...
export default function Header() {
  return (
    <header className={`sticky top-0`}>
      <nav></nav>
      <div className={`grid grid-flow-col gap-8 px-8 py-6`}>
        <nav
          id="content-nav"
          className={`grid grid-flow-col justify-start content-start gap-8`}
        >
          <Link href="">
            <a>Men</a>
          </Link>
        ...
        <nav
          className={`grid grid-flow-col justify-center content-center gap-8`}
        >
          <Link href="/">
            <a
              className={`font-display text-center font-bold uppercase tracking-wider`}
            >
              <svg
        ...
        <nav
          id="tool-nav"
          className={`grid grid-flow-col justify-end content-end gap-8`}
        >
          <Link href="">
            <a>Search</a>
          </Link>
